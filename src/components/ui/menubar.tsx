...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      className={cn(
        "min-h-7 gap-2 rounded-lg px-2 py-1 text-xs focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-7.5 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-3.5",
        className
      )}
      {...props}
    />
